...
@app.route('/')
def home():
    # IMPORTANTE: o morador NÃO deve acessar o painel geral (/).
    # - Admin/Central: pode ver a Home (atalhos)
    # - Morador: sempre vai para /sos (com chave via link oficial)
    if session.get('admin_auth') or session.get('central_auth'):
